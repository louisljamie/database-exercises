...
AS days_working
FROM employees
WHERE hire_date BETWEEN '1990-01-01' AND '1999-12-31' AND birth_date LIKE 
'%-12-25';
...
SELECT concat(lower(left(first_name, 1)), lower(left(last_name, 4)), '_', 
month(birth_date), right(year(birth_date), 2)) AS username
FROM employees
LIMIT 10;
