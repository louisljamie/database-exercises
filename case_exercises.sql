/*Write a MYSQL query that returns all employees, all department numbers, all their start date, 
their end date, and a new column 'is_current_employee' that is a 1 if 
the employee is still with the company and 0 if not. */
