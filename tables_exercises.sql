-- 2 Use the employees database. Write the SQL code necessary to do this. 

USE employees;

-- 3 List all the tables in the database. Write the SQL code necessary to accomplish this.
